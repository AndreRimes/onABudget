...
export default function Hero() {
    return (
        <div className="w-full md:w-1/2 h-full flex flex-col items-center justify-center p-4">
            ...
            <div className="w-full md:w-[80%] py-10">
                <Revel>
                    <Link href="/signup" >
                        <button className=" bg-[#9400D3] btn-cadastro transition-all duration-300 ease-out text-lg w-[40%] h-10 rounded-md">Cadastro</button>
                    </Link>
                    <Link href="/login">
